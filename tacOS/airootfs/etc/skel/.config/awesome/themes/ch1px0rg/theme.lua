...
----------------------------------------------------------------------------------------------------
 ▸ $XDG_CONFIG_HOME/awesome/themes/ch1px0rg/theme.lua
----------------------------------------------------------------------------------------------------
...
local thisdir=themedir .. "/ch1px0rg"
...
if awful.util.file_readable(thisdir .. "/theme.lua") then
	...
	themefile=home .. ".config/awesome/themes/ch1px0rg/theme.lua"
end
