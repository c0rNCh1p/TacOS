...
local screen=screen
local centerwork={name='centerwork', horizontal={name='centerworkh'}}
...
-- Drop in replacements for awful.client.focus.byidx and awful.client.swap.byidxthat behaves
-- consistently with other layouts.
