...
function util.menu_clients_current_tags(menu, args)
	...
	-- menu may contain some predefined values, otherwise start with a fresh menu.
...
-- Non-empty tag browsing direction in {-1, 1} <-> {previous, next} non-empty tag
...
-- Move current tag pos in {-1, 1} <-> {previous, next} tag position
