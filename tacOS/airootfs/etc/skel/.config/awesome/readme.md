...
desired from this repo is the Awesome config, feel free to save and run the shell script
provided below, it will need to be made executable (chmod explained in main readme):
```sh
#!/bin/bash
