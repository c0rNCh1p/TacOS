...
#### AwesomeWM
For information about the AwesomeWM configuration installed with TacOS, see the [config
readme](gitlab.com/c0rNCh1p/tacos/-/tree/master/tacOS/airootfs/etc/skel/.config/awesome).
##
#### Installation
##
#### Installing Arch
